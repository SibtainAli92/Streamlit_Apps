...
kaggle_redirect_url_url = "https://miro.medium.com/v2/resize:fit:837/1*tI-TWV--K05xbXUgA4Qm1w.png"

# redirect urls
github_redirect_url = "https://github.com/SibtainAli92"
...
st.markdown(f'<div class="footer">Made with ❤️ by Muhammad Sibtain Ali<a href="{github_redirect_url}"><img src="{github_url}" width="30" height="30"></a>'
             f'<a href="{kaggle_redirect_url}"><img src="{kaggle_redirect_url_url}" width="30" height="30"></a>'
             '| Credits: Dr.Ammaar Tufail</div>', unsafe_allow_html=True)