...
# add title
st.title('Data Analysis Aplication')
...
st.write('Number of Column:', df.shape[0])

# display the columns of selected data with their data types
st.write('Column  names & Data Types:', df.dtypes)
